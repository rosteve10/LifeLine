...
import com.example.mylifeline.models.DistanceDuration;
...
public class HospitalLoacator extends AppCompatActivity implements OnMapReadyCallback {
    ...
    Context ctx = HospitalLoacator.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_loacator);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        toolbar.setTitle("Hospital Locator");
//        toolbar.setScrollBarSize(20);
...
//                addMapMarker(new LatLng(28.6566,77.18432),"Test loc","testing");
    ...
    void showDetailList() {
        Intent i = new Intent(this, HospitalList.class);
